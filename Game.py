    ...
    def login_or_register(self):
        ...
        while(True):
            ...
            if(choice == 1):
                ...
                info = [name,username,email,password] # USER DETAILS INFO
    ...
    def play_snakes_and_ladders(self):
        ...
        while not game_over:
            for i in range(2):
                ...
                print(f"\nPlayer {i + 1} playing!")
                print(f"Press {i + 1} to roll the dice player {i + 1}!(Enter 0 For Exit)")
                choice = int(input())
                ...
                if choice == i + 1:
                    ...
                    print("Game Aborted Forcefully. Thank You")
                    return self.menu()
                else:
